...
<?php
$datos= "SELECT u.Usuario_Id, u.Nombre, u.ApellidoPat, u.ApellidoMat, u.usuario, u.password, r.Rol_NOMBRE
FROM Usuarios u
INNER JOIN Rol r ON u.Usuario_RolID = r.Rol_id";
...
<tr>  
  ...
  <td><?php echo $mostrar['Rol_NOMBRE']?>   </td>
  <td>
  <div style="display: flex; justify-content: space-between;">
    <a href="Actualizauser.php?id=<?php echo $mostrar['Usuario_Id'] ?>" class="btn btn-info">Editar</a>
    <a href="borraruser.php?id=<?php echo $mostrar['Usuario_Id'] ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoría?')">Eliminar</a>
  </div>
</td>
