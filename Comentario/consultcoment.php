...
<header class="container-fluid bg-secondary d-flex justify-content-center">
  <p class="text-light mb-0 p-2 fs-5"></p>
</header>
...
<!--========================================================== -->
 ...
 <h1 class= text-center>Comentario </h1>
 ...
 <table class="table " >
   <thead class="table-success table-striped" >
        ...
        <th scope="col">fecha_comentario</th>
...
<?php
       ...
       $datos = "SELECT comentario.id_comentario, comentario.comentario, comentario.fecha_comentario,  entrada.texto_entrada
       FROM comentario 
       INNER JOIN entrada ON comentario.id_entrada = entrada.id_entrada";
        ...
        ?>
          ...
          <tr>  
            ...
            <td><?php echo $mostrar['texto_entrada']?>    </td>
    
            <th><a href="actualizacomentario.php?id=<?php echo $mostrar['id_comentario'] ?>" class="btn btn-info">Editar</a>
            <a href="eliminacoment.php?id=<?php echo $mostrar['id_comentario'] ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoría?')">eliminar</a></th>
</th>
