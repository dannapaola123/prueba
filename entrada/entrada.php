...
<?php
       ...
       $datos = "SELECT entrada.id_entrada, entrada.texto_entrada, blog.id_blog, blog.titulo
       FROM entrada 
       INNER JOIN blog ON entrada.id_blog = blog.id_blog";
        ...
        ?>
          ...
          <tr>  
            ...
            <th><a href="enactualizar.php?id=<?php echo $mostrar['id_entrada'] ?>" class="btn btn-info">Editar</a>
            <a href="entraElimina.php?id=<?php echo $mostrar['id_entrada'] ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoría?')">eliminar</a></th>
