...
<?php
        ...
        ?>
          ...
          <tr>  
            ...
            <th><a href="actualizar.php?id=<?php echo $mostrar['id_categoria'] ?>" class="btn btn-info">Editar</a></th>
            <th><a href="eliminarcat.php?id=<?php echo $mostrar['id_categoria'] ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoría?')">eliminar</a></th>
          </tr>  
          <?php                    
        }
        ?>
