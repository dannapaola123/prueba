...
<html lang="en">
  ...
  <!--========================================================== -->
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <div class="dropdown">
                ...
                <li><a class="dropdown-item" href="mapa/mapa.html">Mapa</a></li>
            ...
            <form class="d-flex">
              <a href="./Login1/login.php"> <button class="btn btn-primary btn-primary-outline-success" type="button">Inicia Sesión</button></a>
            </form>
          </div>
    ...
    <div id="carousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item" data-bs-interval="3000">
            <img src="./img/news.webp" class="d-block w-100" alt="im2">
          </div>
    ...
    <h1 class="p-3 fs-2 border-top border-3">Un servicio<span class="text-primary"> Calles inseguras </span></h1>
     <p class="p-3  fs-4">
         <span class="text-primary">InfoHelp UT</span> Es un sistema pensado en tu seguirad, informandote acerca de los diversos 
         casos de violencia que pueden ocurrir en tu localidad.        
     </p>   
    </section>
