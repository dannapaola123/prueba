...
<!--========================================================== -->
 ...
 <table class="table " >
   <thead class="table-success table-striped" >
        ...
        <th scope="col">Lo creo</th>
            <th></th>
                                        <th></th>
        </tr>
        </thead>

        <a href="registroblog.php">
  <button type="button">insertar</button>
</a>

<?php       
$datos = "SELECT blog.id_blog, blog.fecha_creacion, blog.titulo, categoria.descripcion, usuarios.usuario
FROM blog
INNER JOIN categoria ON blog.id_categoria = categoria.id_categoria
INNER JOIN usuarios ON blog.id_usuario = usuarios.Usuario_Id";
...
?>
  ...
  <tr>  
    <td><?php echo $mostrar['id_blog']?>   </td>
    ...
    <th><a href="blogactualizar.php?id=<?php echo $mostrar['id_blog'] ?>" class="btn btn-info">Editar</a>
    <a href="blogdelete.php?id=<?php echo $mostrar['id_blog'] ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta categoría?')">eliminar</a></th>
    </th>
  </tr>  
