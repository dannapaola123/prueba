...
<!--========================================================== -->
 ...
 <table class="table " >
  ...
  <button type="button">insertar</button>
        ...
        <?php
  $datos = "SELECT imagen.id_imagen, imagen.ruta, blog.titulo
            FROM imagen 
            INNER JOIN blog ON imagen.id_blog = blog.id_blog";
...
?>
  ...
  <tr>  
    ...
    <td><img src="data:image/jpeg;base64,<?php echo base64_encode($mostrar['ruta']) ?>" width="100" height="100"></td>
    <td><?php echo $mostrar['titulo']?></td>
    <td>
      <a href='actualizarimg.php?id=<?php echo $mostrar["id_imagen"] ?>' class='btn btn-primary'>Editar</a>
      <a href='Eliminarimg.php?id=<?php echo $mostrar["id_imagen"] ?>' onclick='return confirm("¿Está seguro de que desea eliminar esta imagen?")' class='btn btn-danger'>Eliminar</a>
    </td>
  </tr>
